...
| Size | 5 layers · 8 heads · 256 dim · 128 context · **4.55M parameters** |
| Tokenizer | word-level, 2,219-token vocabulary |
| Training data | 158,917 synthetic conversations (~4.5M tokens) generated by `training/make_corpus.py`: chat, jokes, riddles, facts, stories, 60+ world capitals, all 50 US state capitals, continents & languages, chemical elements, planet moons, famous people, holidays, animal facts, spelling, counting, translations in 5 languages, synonyms & opposites, word problems, +−×÷ math drills up to 12×12 and 20+20, science & body facts |
