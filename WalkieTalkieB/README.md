...
Internet push-to-talk walkie-talkie. Pair app: [`WalkieTalkieA/`](../WalkieTalkieA/) (identical, different name/color so both fit on one phone).
...
1. Install Walkie B on one phone and Walkie A on the other (or the same app on both — any mix works, they share the protocol).
